...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="#home">Jauharuddin</a>
  ...
  <div class="jumbotron" id="home">
    <div class="container">
      <div class="text-center">
        ...
        <h1 class="display-4">Jauharuddin</h1>
          ...
          <div class="row mt-3 pb-3">
            <div class="col">
              <div class="ratio ratio-4x3">
                <iframe src="https://www.youtube.com/embed/RWWX5AhV1VI" title="YouTube video" allowfullscreen width="400" height="250"></iframe>
              </div>
            </div>
          </div>
        </div>
